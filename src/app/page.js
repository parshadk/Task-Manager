    ...
    <DndProvider backend={HTML5Backend}>
      <div className="container mx-auto p-4">
        ...
        <div className="flex mb-4">
          <button className="bg-blue-500 hover:bg-blue-700 font-bold py-2 px-4 rounded-full text-black p-2" onClick={openModal}>
            Add Task
          </button>
        </div>
        <div className="flex space-x-4  text-black p-2">
          <Box
            status="ToDo"
        ...
        >
          ...
          <div className="flex justify-end">
            <button onClick={closeModal} className="bg-gray-400 hover:bg-blue-700 font-bold py-2 px-4 rounded-full text-black p-2 mr-2">Cancel</button>
            <button onClick={addTask} className="bg-blue-500 hover:bg-blue-700 font-bold py-2 px-4 rounded-full text-black p-2">{isEditing ? 'Edit Task' : 'Add Task'}</button>
          </div>
        </Modal>
      </div>
    </DndProvider>
